...
<div class="hero-slider">
  <!-- Slider Item -->
  <div class="slider-item slide1" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/slider/slider-bg-1.jpg)">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <!-- Slide Content Start -->
  ...
  <!-- Slider Item -->
  <div class="slider-item" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/slider/slider-bg-2.jpg);">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <!-- Slide Content Start-->
  ...
  <!-- Slider Item -->
  <div class="slider-item" style="background-image:url(<?php echo get_bloginfo('template_url'); ?>/images/slider/slider-bg-3.jpg)">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <!-- Slide Content Start -->
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="item">
                <div class="icon-box">
                  <figure>
                    <a href="services.html"><img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/resource/1.png" alt="features image"></a>
                  </figure>
                </div>
                ...
                <div class="icon-box">
                  <figure>
                    <a href="services.html">
                      <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/resource/2.png" alt="features image">
                    </a>
                  </figure>
                </div>
            ...
            <div class="col-sm-6">
              <div class="item">
                <div class="icon-box">
                  <figure>
                    <a href="services.html">
                      <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/resource/3.png" alt="features image">
                    </a>
                  </figure>
                </div>
            ...
            <div class="col-sm-6">
              <div class="item">
                <div class="icon-box">
                  <figure>
                    <a href="services.html">
                      <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/resource/4.png" alt="features image">
                    </a>
                  </figure>
                </div>
        ...
        <div class="col-md-12">
          ...
          <div class="tab-content" id="aboutTab">
            <div class="service-box tab-pane fade show active" id="dormitory">
              <div class="row">
                <div class="col-lg-6">
                  <img loading="lazy" class="img-fluid" src="<?php echo get_bloginfo('template_url'); ?>/images/services/service-one.jpg" alt="service-image">
                </div>
                <div class="col-lg-6">
                  <div class="contents">
            ...
            <div class="service-box tab-pane fade" id="orthopedic">
              <div class="row">
                <div class="col-lg-6">
                  <img loading="lazy" class="img-fluid" src="<?php echo get_bloginfo('template_url'); ?>/images/services/service-two.jpg" alt="service-image">
                </div>
                <div class="col-lg-6">
                  <div class="contents">
                    <div class="section-title">
            ...
            <div class="service-box tab-pane fade" id="sonogram">
              <div class="row">
                <div class="col-lg-6">
                  <img loading="lazy" class="img-fluid" src="<?php echo get_bloginfo('template_url'); ?>/images/services/service-three.jpg" alt="service-image">
                </div>
                <div class="col-lg-6">
                  <div class="contents">
                    <div class="section-title">
            ...
            <div class="service-box tab-pane fade" id="x-ray">
              <div class="row">
                <div class="col-lg-6">
                  <img loading="lazy" class="img-fluid" src="<?php echo get_bloginfo('template_url'); ?>/images/services/service-four.jpg" alt="service-image">
                </div>
                <div class="col-lg-6">
                  <div class="contents">
                    <div class="section-title">
            ...
            <div class="service-box tab-pane fade" id="diagnostic">
              <div class="row">
                <div class="col-lg-6">
                  <img loading="lazy" class="img-fluid" src="<?php echo get_bloginfo('template_url'); ?>/images/services/service-five.jpg" alt="service-image">
                </div>
                <div class="col-lg-6">
                  <div class="contents">
                    <div class="section-title">
        ...
        <div class="items-container">
          <div class="item">
            <div class="inner-box">
              <div class="img_holder">
                <a href="service.html">
                  <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/gallery/1.jpg" alt="images" class="img-fluid">
                </a>
              </div>
          ...
          <div class="item">
            <div class="inner-box">
              <div class="img_holder">
                <a href="service.html">
                  <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/gallery/2.jpg" alt="images" class="img-fluid">
                </a>
              </div>
              <div class="image-content text-center">
                <span>Better Service At Low Cost</span>
          ...
          <div class="item">
            <div class="inner-box">
              <div class="img_holder">
                <a href="service.html">
                  <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/gallery/3.jpg" alt="images" class="img-fluid">
                </a>
              </div>
              <div class="image-content text-center">
                <span>Better Service At Low Cost</span>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/team/doctor-2.jpg" alt="doctor" class="img-fluid">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/team/doctor-lab-3.jpg" alt="doctor" class="img-fluid">
          <div class="contents text-center">
            <h4>Dr. Marry Lou</h4>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dignissimos, aspernatur.</p>
            <a href="appointment.html" class="btn btn-main">Book Appointment</a>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/team/event-2.jpg" alt="doctor" class="img-fluid">
          <div class="contents text-center">
...
<!--testimonial-section-->
<section class="testimonial-section" style="background: url(<?php echo get_bloginfo('template_url'); ?>/images/testimonials/1.jpg);">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title text-center">
        ...
        <div class="testimonial-carousel">
          ...
          <div class="slide-item">
            <div class="inner-box text-center">
              <div class="image-box">
                <figure>
                  <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/testimonials/1.png" alt="">
                </figure>
              </div>
              <h6>Adam Rose</h6>
          ...
          <div class="slide-item">
            <div class="inner-box text-center">
              <div class="image-box">
                <figure>
                  <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/testimonials/2.png" alt="">
                </figure>
              </div>
              <h6>David Warner</h6>
              <p class="mb-0">Neque porro quisquam est, qui dolorem ipsum quia consectetur, dolor sit amet, consectetur, numquam Lorem
          ...
          <div class="slide-item">
            <div class="inner-box text-center">
              <div class="image-box">
                <figure>
                  <img loading="lazy" src="<?php echo get_bloginfo('template_url'); ?>/images/testimonials/3.png" alt="">
                </figure>
              </div>
              <h6>Amy Adams</h6>
              <p class="mb-0">Neque porro quisquam est, qui dolorem ipsum quia consectetur, dolor sit amet, consectetur, numquam Lorem
